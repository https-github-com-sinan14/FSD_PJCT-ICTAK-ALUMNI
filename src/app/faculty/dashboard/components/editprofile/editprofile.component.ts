...
export class EditprofileComponent implements OnInit {
  ...
  str = this.dob.toDateString();
    ...
    constructor(private http: HttpClient,private router:Router ,private facultyservice:AuthService, private formBuilder: FormBuilder) {
      ...
      ngOnInit(): void {
        ...
        this.facultyservice.getdetails(userId).subscribe((data) =>{
    ...
    onSubmit() {
      ...
      if (this.JobpostForm.invalid) {
        ...
        this.facultyservice.updateUser(this.user);
      Swal.fire({
        position: 'top-end',
        icon: 'success',
        title: 'Successful!!!',
